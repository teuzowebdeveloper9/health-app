  ...
  return user ? (
    ...
    <ScrollView style={styles.container}>
      ...
      <View style={styles.lowView}>
        <Text style={styles.welcomeText}>welcome to health help</Text>
        <Text style={styles.bannerText}>{"login or sign in"}</Text>
        <View>
          {login ? (
            <LoginFormComponent isLogin={false} onPress={polarity} />
          ) : (
            <LoginFormComponent isLogin={true} onPress={polarity} />
          )}
        </View>
      </View>
    </ScrollView>
